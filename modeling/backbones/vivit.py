...
class ViViT(nn.Module):
    def __init__(self, image_size_h, image_size_w, patch_size_h, patch_size_w, num_frames, dim = 768, depth = 4, heads = 3, pool = 'cls', in_channels = 3, dim_head = 64, dropout = 0.,
...
if __name__ == "__main__":
    ...
    img = torch.ones([4, 16, 3, 256, 128]).cuda()
    
    model = ViViT(256, 128, 16, 16, 16).cuda()
