...
from fastreid.evaluation import (ReidEvaluator,
                                 inference_on_dataset, inference_retrieval, print_csv_format)
...
class DefaultTrainer(TrainerBase):
    ...
    def test(cls, cfg, model):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TESTS):
            ...
            # WiFi Vision检索
            results_r = inference_retrieval(model, data_loader, evaluator)
            ...
            if comm.is_main_process():
                ...
                logger.info("Evaluation results for {} in csv format:".format('retrieval'))
                results_r['dataset'] = dataset_name + "_retrieval"
                print_csv_format(results_r)
